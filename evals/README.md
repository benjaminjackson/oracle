...
- `configs.jsonl` — the run matrix: efforts {low, medium, default} × prompts
  {P0 current concise, P1 Chain-of-Draft sketch} + P2 one-liner control, plus
  follow-up density variants p3–p7 (see Results below). `p0-default` was the
  original incumbent; `p6-shorthand` is what SKILL.md ships now.
